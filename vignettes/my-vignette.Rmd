...
model.LGD.D1 = LinCDE.boost(X = X, y = y.LGD, depth = 1, df = 2, n.trees = 100, verbose = FALSE)
predict.LGD.D1 = predict(object = model.LGD.D1, X = XVal, y = yVal.LGD, densityOnly = FALSE)

model.LGD.D2 = LinCDE.boost(y = y.LGD, X = X, depth = 2, df = 2, n.trees = 100, verbose = FALSE) 
...
model.skewness = LinCDE.boost(X = X, y = y.skewness, df = 8,
                                 depth = 3, n.trees = 200, shrinkage = 0.2,   
                                 alpha = 0.8)
```
