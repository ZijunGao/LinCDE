...
exampleD1 = LinCDEBoosting(y = y, X = X, depth = 1, n.trees = 10) # 100
...
```{r,fig.height=5.3, fig.width = 7, fig.align="center", cache=TRUE}
# conditional density plot
XProfile = matrix(runif(3^2 * d,-1,1), nrow = 3^2, ncol = d)
...
exampleAugmentation = LinCDEBoosting(y = y, X = X, depth = 2, n.trees = 200, shrinkage = 0.02)
# with mean augmentation
exampleAugmentationOLS = LinCDEBoosting(y = y, X = X, depth = 2, n.trees = 200, shrinkage = 0.02, augmentation = TRUE, augmentationMethod = "linearRegression")
```
